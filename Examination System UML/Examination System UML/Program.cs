...
public class Program
{
    ...
    static public List<Student> Students = new List<Student> {
        ...
        new Student{Id=5    ,FirstName = "Hafsa"     ,LastName = "Ebrahim"     ,Department = Departments[5]           ,Username = "Hafsa_Ebrahim5"         ,Password = "Ebrahim_Hafsa5"        , Courses = new List<Course>()},
        new Student{Id=6    ,FirstName = "Dina"      ,LastName = "Samir"       ,Department = Departments[6]           ,Username = "Dina_Samir6"            ,Password = "Samir_Dina6"           , Courses = new List<Course>()},
        new Student{Id=7    ,FirstName = "Khaled"    ,LastName = "Ayman"       ,Department = Departments[7]           ,Username = "Khaled_Ayman7"          ,Password = "Ayman_Khaled7"         , Courses = new List<Course>()},
        new Student{Id=8    ,FirstName = "Ahmed"     ,LastName = "Muhammed"    ,Department = Departments[8]           ,Username = "Ahmed_Muhammed8"        ,Password = "Muhammed_Ahmed8"       , Courses = new List<Course>()},
        new Student{Id=9    ,FirstName = "Ahmed"     ,LastName = "Negmeldin"   ,Department = Departments[9]           ,Username = "Ahmed_Negmeldin9"       ,Password = "Negmeldin_Ahmed9"      , Courses = new List<Course>()},
        new Student{Id=10   ,FirstName = "Raouf"     ,LastName = "Alaadin"     ,Department = Departments[1]           ,Username = "Raouf_Alaadin10"        ,Password = "Alaadin_Raouf10"       , Courses = new List<Course>()},
        new Student{Id=11   ,FirstName = "Karim"     ,LastName = "Eid"         ,Department = Departments[1]           ,Username = "Karim_Eid11"            ,Password = "Eid_Karim11"           , Courses = new List<Course>()},
        new Student{Id=12   ,FirstName = "Shrief"    ,LastName = "Hesham"      ,Department = Departments[2]           ,Username = "Shrief_Hesham12"        ,Password = "Hesham_Shrief12"       , Courses = new List<Course>()},
        new Student{Id=13   ,FirstName = "Abdallah"  ,LastName = "Mohamed"     ,Department = Departments[3]           ,Username = "Abdallah_Mohamed13"     ,Password = "Mohamed_Abdallah13"    , Courses = new List<Course>()},
        new Student{Id=14   ,FirstName = "Mina"      ,LastName = "Yossry"      ,Department = Departments[4]           ,Username = "Mina_Yossry14"          ,Password = "Yossry_Mina14"         , Courses = new List<Course>()},
        new Student{Id=15   ,FirstName = "Hossam"    ,LastName = "Mahmoud"     ,Department = Departments[5]           ,Username = "Hossam_Mahmoud15"       ,Password = "Mahmoud_Hossam15"      , Courses = new List<Course>()},
        new Student{Id=16   ,FirstName = "Maged"     ,LastName = "Samir"       ,Department = Departments[6]           ,Username = "Maged_Samir16"          ,Password = "Samir_Maged16"         , Courses = new List<Course>()},
        new Student{Id=17   ,FirstName = "Mohaned"   ,LastName = "Saudi"       ,Department = Departments[7]           ,Username = "Mohaned_Saudi17"        ,Password = "Saudi_Mohaned17"       , Courses = new List<Course>()},
        new Student{Id=18   ,FirstName = "Asmaa"     ,LastName = "Mohamed"     ,Department = Departments[8]           ,Username = "Asmaa_Mohamed18"        ,Password = "Mohamed_Asmaa18"       , Courses = new List<Course>()},
        new Student{Id=19   ,FirstName = "Zeinab"    ,LastName = "Mahmoud"     ,Department = Departments[9]           ,Username = "Zeinab_Mahmoud19"       ,Password = "Mahmoud_Zeinab19"      , Courses = new List<Course>()},
        new Student{Id=20   ,FirstName = "Shahenda"  ,LastName = "Hamdy"       ,Department = Departments[1]           ,Username = "Shahenda_Hamdy20"       ,Password = "Hamdy_Shahenda20"      , Courses = new List<Course>()},
        new Student{Id=21   ,FirstName = "Heba"      ,LastName = "Allah"       ,Department = Departments[1]           ,Username = "Heba_Allah21"           ,Password = "Allah_Heba21"          , Courses = new List<Course>()},
        new Student{Id=22   ,FirstName = "Maha"      ,LastName = "Yehia"       ,Department = Departments[2]           ,Username = "Maha_Yehia22"           ,Password = "Yehia_Maha22"          , Courses = new List<Course>()},
        new Student{Id=23   ,FirstName = "Mohamed"   ,LastName = "Refaat"      ,Department = Departments[3]           ,Username = "Mohamed_Refaat23"       ,Password = "Refaat_Mohamed23"      , Courses = new List<Course>()},
        new Student{Id=24   ,FirstName = "Youssef"   ,LastName = "Ehab"        ,Department = Departments[4]           ,Username = "Youssef_Ehab24"         ,Password = "Ehab_Youssef24"        , Courses = new List<Course>()},
        new Student{Id=25   ,FirstName = "Omar"      ,LastName = "Mosaad"      ,Department = Departments[5]           ,Username = "Omar_Mosaad25"          ,Password = "Mosaad_Omar25"         , Courses = new List<Course>()},
        new Student{Id=26   ,FirstName = "Amr"       ,LastName = "Sherif"      ,Department = Departments[6]           ,Username = "Amr_Sherif26"           ,Password = "Sherif_Amr26"          , Courses = new List<Course>()},
        new Student{Id=27   ,FirstName = "Khaled"    ,LastName = "Magdy"       ,Department = Departments[7]           ,Username = "Khaled_Magdy27"         ,Password = "Magdy_Khaled27"        , Courses = new List<Course>()},
        new Student{Id=28   ,FirstName = "Mahmoud"   ,LastName = "Sherif"      ,Department = Departments[8]           ,Username = "Mahmoud_Sherif28"       ,Password = "Sherif_Mahmoud28"      , Courses = new List<Course>()},
        new Student{Id=29   ,FirstName = "Mohamed"   ,LastName = "Abdelfattah" ,Department = Departments[9]           ,Username = "Mohamed_Abdelfattah29"  ,Password = "Abdelfattah_Mohamed29" , Courses = new List<Course>()},
        new Student{Id=30   ,FirstName = "Hesham"    ,LastName = "Essam"       ,Department = Departments[1]           ,Username = "Hesham_Essam30"         ,Password = "Essam_Hesham30"        , Courses = new List<Course>()},
        new Student{Id=31   ,FirstName = "Ahmed"     ,LastName = "Taha"        ,Department = Departments[1]           ,Username = "Ahmed_Taha31"           ,Password = "Taha_Ahmed31"          , Courses = new List<Course>()},
        new Student{Id=32   ,FirstName = "Ahmed"     ,LastName = "Mohamed"     ,Department = Departments[2]           ,Username = "Ahmed_Mohamed32"        ,Password = "Mohamed_Ahmed32"       , Courses = new List<Course>()},
        new Student{Id=33   ,FirstName = "Mahmoud"   ,LastName = "Hossam"      ,Department = Departments[3]           ,Username = "Mahmoud_Hossam33"       ,Password = "Hossam_Mahmoud33"      , Courses = new List<Course>()},
        new Student{Id=34   ,FirstName = "Mohammed"  ,LastName = "Ahmed"       ,Department = Departments[4]           ,Username = "Mohammed_Ahmed34"       ,Password = "Ahmed_Mohammed34"      , Courses = new List<Course>()},
    };
